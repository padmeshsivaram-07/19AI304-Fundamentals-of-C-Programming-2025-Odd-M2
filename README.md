...
```
# Output:
![alt text](<Screenshot 2025-12-26 191710.png>)
...
```
# Output:
![alt text](<Screenshot 2025-12-26 191745.png>)
# Result: 
Thus, the program was implemented and executed successfully, and the required output was obtained.
...
```
# Output:
![alt text](<Screenshot 2025-12-26 191816.png>)
# Result: 
Thus, the program was implemented and executed successfully, and the required output was obtained.
...
```
# Output:
![alt text](<Screenshot 2025-12-26 194711.png>)
...
```
# Output:
![alt text](<Screenshot 2025-12-26 194456.png>)
